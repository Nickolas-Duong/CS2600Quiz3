...
//Essentially the same functionality as above but comparing phone numbers to check if equal 
...
//Essentially the same functionality as above but comparing salaries to check if equal 
